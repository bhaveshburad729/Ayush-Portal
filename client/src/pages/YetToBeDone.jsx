...
const YetToBeDone = () => {
  ...
  return (
    <>
      <h1 style={{ textAlign: "center", fontSize: "2rem" }}>Upload Doc</h1>
      <h1 style={{ textAlign: "center", fontSize: "2rem" }}>Verify by Gov Agent</h1>
      <h1 style={{ textAlign: "center", fontSize: "2rem" }}>Give Permission</h1>
