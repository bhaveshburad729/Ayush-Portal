...
import Licence from "./pages/licence/licence.jsx";
import ImageResizer from "./pages/ImageResizer/ImageResizer.jsx";
import AyurvedaLicenseLink from "./pages/AyurvedaLicenseLink/AyurvedaLicenseLink.jsx";
    ...
    <>
      ...
      <div className="App">
        <Routes>
          ...
          <Route path="/Apply-licences" element={<Licence/>} />
          <Route path="/imageresizer-a" element={<ImageResizer/>} />
          ...
          <Route path="/ayurvedaLicenseLink" element={<AyurvedaLicenseLink />} />
